        ...
        <Container>
            <footer className={`py-3 my-4 ${fixedBottom}`}>
                <ul className="nav justify-content-center border-bottom pb-3 mb-3">
                    <li className="nav-item"><a href="/search" className="nav-link px-2 text-muted">Home</a></li>
                    <li className="nav-item"><a href="#" className="nav-link px-2 text-muted">Involvement</a></li>
